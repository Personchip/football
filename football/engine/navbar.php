        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-light row navbar-expand-md" role="navigation">
                    <a class="navbar-brand link-phpless-style" href="<?php echo URL; ?>"></a>
                    <button id="nav-toggle" type="button"
                        class="ml-auto ui-navbar-toggler navbar-toggler border-0 p-0 menu-icon-circles"
                        data-toggle="collapse" data-target=".navbar-3665" aria-expanded="false"
                    ...
                    <div class="collapse navbar-collapse navbar-3665">
                        <ul class="site-navigation nav navbar-nav ml-auto">
                            ...
                            switch (!$user) {
                                ...
                                case 0:
                                    echo '
                                    <li class="nav-item"><a href="' . URL . '/main.php" class="nav-link a-btn">' . $lang_nav['Trainer'] . '</a></li>
                                    <li class="nav-item"><a href="' . URL . '/profile/" class="nav-link a-btn">' . $lang_nav['Profile'] . '</a></li>
                                    <li class="nav-item"><a href="' . URL . '/index2.php/?logout" class="nav-link a-btn">' . $lang_nav['Sign Out'] . '</a></li>';
                                    break;
                            }
                            ?>
                        </ul>
