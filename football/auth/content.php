                ...
                <form method="post">
                    ...
                    if (!$user) {
                        if (isset($login, $password)) {
                            if ($result = !authentication($login, $password)) {
                                ...
                                header('Location:  http://football/index2.php');
                                exit;
                            }
                        }
                    } else {
                    ...
                    <div class="form-group container-div-margin-top">
                        ...
                        <input name="Login" id="login_input" class="form-control"
                            placeholder="<?php echo $lang_auth['Enter your login']; ?>" maxlength="32" required />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="Password" id="password_input" type="password" class="form-control"
                            placeholder="<?php echo $lang_auth['Enter the password']; ?>" maxlength="64" required />
                    </div>

                    <button type="submit"
                        class="bloc-button btn float-lg-right btn-margin-bottom btn-d"><?php echo $lang_auth['Continue']; ?></button>
